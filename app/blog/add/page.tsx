  ...
  return <Fragment>
    ...
    <div className='w-full m-auto flex my-4'>
      <div className='flex flex-col justify-center items-center m-auto'>
        <p className='text-2xl text-slate-200 font-bold p-3z'>Add a Wonderfull blog</p>
        <form onSubmit={handleSubmit}>
          <input placeholder='Enter Title' type="text" ref={titleRef}
          className='rounded-md px-4 py-2 my-2 w-full' />
          <textarea placeholder='Enter Description' ref={descriptionRef}className='rounded-md px-4 py-2 w-full my-2'></textarea>
